...
public class SlimeShapedRecipe extends NormalCraftingRecipe {
    ...
    public static final RecipeSerializer<SlimeShapedRecipe> SERIALIZER = new RecipeSerializer<>(MAP_CODEC, STREAM_CODEC);
