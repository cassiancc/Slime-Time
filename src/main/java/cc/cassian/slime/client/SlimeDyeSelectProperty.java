...
public record SlimeDyeSelectProperty() implements SelectPropertyHandler {
...
//	public static final SelectItemModelProperty.Type<SlimeDyeSelectProperty, SlimeColor> TYPE = SelectItemModelProperty.Type.create(MapCodec.unit(new SlimeDyeSelectProperty()), VALUE_CODEC);
	...
	@Override
	public String getValue(ItemStack itemStack, LivingEntity livingEntity, ItemDisplayContext itemDisplayContext, SelectDefinition.Definition definition) {
		return get(itemStack, null, null, -1, null).getName();
	}
}
