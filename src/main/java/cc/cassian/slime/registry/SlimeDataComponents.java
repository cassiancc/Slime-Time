...
public class SlimeDataComponents {
    ...
    public static final DataComponentType<SlimeColor> DYED_COLOR = registerComponentType(
            "dyed_color", b -> b.persistent(SlimeColor.CODEC).networkSynchronized(SlimeColor.STREAM_CODEC)
    );
